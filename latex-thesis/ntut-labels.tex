...
\newcommand\cTitle{漸進式委員會佔領攻擊與激勵相容防禦：區塊鏈聯邦學習的安全性研究}

% 我的姓名（中文）
% My Name（Chinese）
\newcommand\myCname{陸紀霖}

% 指導教授的姓名 (中文)，使用頓號隔開 
% Advisor (Chinese), use “、” to separate names
\newcommand\advisorCname{張世豪 博士}
...
\newcommand\deptCname{資訊安全碩士學位學程}
...
\newcommand\eTitle{Progressive Committee Capture Attack and Incentive-Compatible Defense: Security Analysis for Blockchain-based Federated Learning}

% 我的姓名（英文）
% My Name（English）
\newcommand\myEname{Lu, Chi-Lin}
...
\newcommand\advisorEname{Dr. Shih-Hao Chang}
